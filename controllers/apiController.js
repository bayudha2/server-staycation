...
module.exports = {
  landingPage: async (req, res) => {
    try {
      ...
      const category = await Category.find()
        ...
        .populate({
          path: 'itemId',
          select: '_id title country city isPopular sumBooking unit imageId',
          perDocumentLimit: 4,
  ...
  detailPage: async (req, res) => {
    try {
      ...
      const testimonial = {
        ...
        name: 'Happy Family',
        rate: 4.55,
        content: 'As a husband i can make happy moments with my family ... ',
        familyName: 'Joko',
  ...
  bookingPage: async (req, res) => {
    ...
    if (
      ...
      return res.status(404).json({ message: 'Not found any needed propery!' });
    }
